...
#include "core4inet/applications/trafficsource/IEEE8021Q/IEEE8021QTrafficSourceApp2.h"
...
Define_Module(IEEE8021QTrafficSourceApp2);

IEEE8021QTrafficSourceApp2::IEEE8021QTrafficSourceApp2()
{
    this->sendInterval = 0;
    this->priority = 0;
    this->vid = 0;
...
void IEEE8021QTrafficSourceApp2::initialize()
{
...
void IEEE8021QTrafficSourceApp2::handleMessage(cMessage *msg)
{
    ...
    if (msg->isSelfMessage())
    {
        ...
        EV << "IEEE8021QTrafficSourceApp2::handleMessage at " << simTime() << "\n";

                if(simTime()<0.001){
                    this->sendInterval=0.00012;
                }else if((simTime()>=0.001)&&(simTime()<0.002)){
...
void IEEE8021QTrafficSourceApp2::sendMessage()
{
...
void IEEE8021QTrafficSourceApp2::handleParameterChange(const char* parname)
{
