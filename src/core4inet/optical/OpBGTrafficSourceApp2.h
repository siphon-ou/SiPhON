...
#ifndef CORE4INET_OpBGTrafficSourceApp2_H_
#define CORE4INET_OpBGTrafficSourceApp2_H_
 ...
 */
class OpBGTrafficSourceApp2 : public virtual TrafficSourceAppBase
{
    private:
        /**
    ...
    public:
        /**
         * @brief Constructor of OpBGTrafficSourceApp2
         */
        OpBGTrafficSourceApp2();
