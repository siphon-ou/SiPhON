...
class SRPTable : public virtual cSimpleModule
{
    ...
    private:
         ...
         */
        //Onur
        std::unordered_map<unsigned long long int, TalkerTable> talkerTables;
        /**
         * map of listener entries for stream id
         */
        //Onur
        std::unordered_map<unsigned long long int, ListenerTable> listenerTables;
        /**
    ...
    public:
         ...
         */
        //Onur
        virtual unsigned long long int getBandwidthForModule(const cModule *module);
        /**
         ...
         */
        //Onur
        virtual unsigned long long int getBandwidthForModuleAndSRClass(const cModule *module, SR_CLASS srClass);
        /**
         ...
         */
        //Onur
        virtual unsigned long long int getBandwidthForStream(uint64_t streamId, uint16_t vid = VLAN_ID_DEFAULT);
        /**
