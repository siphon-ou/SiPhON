...
//Onur
unsigned long long int bandwidthFromSizeAndInterval(size_t framesize, size_t intervalFrames, simtime_t interval)
{
    //Onur
    return static_cast<unsigned long long int>(ceil(
